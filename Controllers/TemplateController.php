...
class TemplateController extends CliController
{
    ...
    public function installActionGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('Action.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installCliActionGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('CliAction.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installControllerGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('Controller.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installCronJobGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('CronJob.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installFilterGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('Filter.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installFormGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('Form.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installMapperGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('Mapper.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installMigrationGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('Migration.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installModelGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('Model.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installModelGeneratedGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('ModelGenerated.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installPluginGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('Plugin.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installQueueableJobGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('QueueableJob.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installServiceGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('Service.php.txt') . ' has been copied to bin/templates.');
    }
    ...
    public function installValidatorGet(): void
    {
        ...
        $this->terminal->message('File ' . $this->terminal->commandText('Validator.php.txt') . ' has been copied to bin/templates.');
    }
